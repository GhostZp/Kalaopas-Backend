 ...
 * @apiSuccess {String} media.fish_name Media's fish name
 ...
 *
 * @apiParam {String} fish_name Fish name of the media (3-128 characters)
 ...
 *       "errors": [
 *         {
 *           "msg": "Fish name must be between 3 and 128 characters",
 *           "param": "fish_name",
 *           "location": "body"
 *         }
 *       ]
 ...
 * @apiSuccess {String} fish_name Media's fish name
